...
for (const route of expectedRoutes) {
  ...
  const requiredMarkup = ['<meta name="description"', '<meta name="keywords"', '<link rel="canonical"', 'href="/favicon.ico"', 'googletagmanager.com/gtag/js?id=G-LVPEX9E4KB', "gtag('config', 'G-LVPEX9E4KB')", 'pl31263720.profitableratecpmnetwork.com/378c33620c3a82c82a3c97b58a404926/invoke.js', 'id="container-378c33620c3a82c82a3c97b58a404926"'];
